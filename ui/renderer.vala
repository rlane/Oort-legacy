...
namespace Oort {
	class Renderer {
		...
		void render_ship(Ship s) {
			...
			var u_scale_matrix = program.uniform("scale_matrix");
			...
			glUniformMatrix4fv(u_scale_matrix, 1, false, scale_matrix.data);
...
void main()
{
	mat4 mv_matrix = translation_matrix * rotation_matrix * scale_matrix;
